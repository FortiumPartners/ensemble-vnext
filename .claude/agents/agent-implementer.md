...
prompt, tool definition, retrieval pipeline, agent loop or eval harness, assume this problem has been met here before and go find where. The engineer who
...
to what you are about to create: a private helper deserves a glance, a prompt that may duplicate an existing one, or a second retrieval path deserves real
looking.
