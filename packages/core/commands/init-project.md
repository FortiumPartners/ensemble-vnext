...
9. **PreCompact Hook** (`PreCompact`) — `.claude/hooks/precompact.js` (archives a decision-trail checkpoint to `.trd-state/<feature>/session-log.md` before context compaction)
