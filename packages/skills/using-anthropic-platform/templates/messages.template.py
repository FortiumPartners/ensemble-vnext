#!/usr/bin/env python3
"""
Anthropic Messages API Template
...
Usage:
    python messages.py "What is Python?"
"""
...
class MessageClient:
    """Anthropic Messages API client with error handling."""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python messages.py <message>")
        sys.exit(1)
